 ...
 */
 ...
 setInterval(() => {
  let frete = $($(".freight-values tbody tr td")[0]).text();
  if(frete == "Frete Grátis") {
    $($(".freight-values tbody tr td")[0]).text("Frete FOB");
    $($(".freight-values tbody tr td")[1]).text("Frete FOB, entrega a combinar para o CEP " + $("#txtCep").val());
  }
 }, 1000);
